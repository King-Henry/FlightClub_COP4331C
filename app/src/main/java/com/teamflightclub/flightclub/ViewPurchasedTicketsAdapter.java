...
public class ViewPurchasedTicketsAdapter extends RecyclerView.Adapter<ViewPurchasedTicketsAdapter.SearchListViewHolder> {

    public static ArrayList<Reservation> purchases;
    static Context contxt;
    public int position;

    public ViewPurchasedTicketsAdapter (ArrayList<Reservation> cartData,Context context) {
        //super();
        purchases = cartData;
        contxt = context;
    }
    ...
    @Override
    public ViewPurchasedTicketsAdapter.SearchListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewPurchasedTicketsAdapter.SearchListViewHolder searchListViewHolder = new ViewPurchasedTicketsAdapter.SearchListViewHolder(view);
        return searchListViewHolder;

    }

    @Override
    public void onBindViewHolder(ViewPurchasedTicketsAdapter.SearchListViewHolder holder, int position) {
...
//        holder.fromToDestinationName.setText("");
        ...
        holder.bind(purchases.get(position),position);
    ...
    public static class FetchthePurchases extends AsyncTask<String,Void,Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            Request request = new Request.Builder()
                    .url("http://teamflightclubproject.com/getPurchases.php?userId="+params[0])
                    .build();
            try {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ViewPurchasedTickets.viewPurchasedTicketsAdapter.notifyDataSetChanged();
        }
    }
